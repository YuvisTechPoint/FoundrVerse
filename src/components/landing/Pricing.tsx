  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-gray-900 py-24 transition-colors duration-300 scroll-mt-28" id="pricing">
      ...
      <div className="relative mx-auto max-w-5xl px-6 sm:px-8">
        ...
        <div className="mx-auto max-w-lg rounded-3xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-10 shadow-2xl transition-colors duration-300">
          <div className="text-center mb-8">
            <div className="flex items-end justify-center gap-2 mb-2">
              <span className="text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white transition-colors duration-300">{formatPrice(1499)}</span>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">One-time payment</p>
          </div>
          ...
          <ul className="space-y-4 mb-10">
            {features.map((feature) => (
              <li key={feature} className="flex items-start gap-3">
                ...
                <span className="text-[15px] text-gray-700 dark:text-gray-300 transition-colors duration-300">{feature}</span>
              </li>
            ))}
          </ul>
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 font-medium transition-colors duration-300">Enroll in 60 seconds</p>
        </div>
      </div>
    </section>
  );
