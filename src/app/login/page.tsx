...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-purple-50/20 to-indigo-50/30 dark:from-gray-900 dark:to-gray-800">
      <Navbar />
      ...
      <div className="max-w-md w-full mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="mt-6 text-4xl font-bold text-gray-900 dark:text-white">Student Login</h1>
